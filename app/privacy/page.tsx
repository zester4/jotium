...
const PrivacyPolicyPage = () => {
  ...
  return (
    <main className="max-w-3xl mx-auto pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Summary at a Glance</h2>
        <ul className="list-disc pl-6">
          <li>Your data belongs to you. We do not sell your personal data.</li>
          <li>You control connected integrations and can revoke access at any time.</li>
          <li>Custom Instructions are stored to personalize your experience and can be edited or cleared.</li>
          <li>API keys and OAuth tokens are stored encrypted at rest and used only on your behalf.</li>
          <li>You can export chats and delete them at any time.</li>
        </ul>
      </section>
    <section className="mb-6">
      ...
      <ul className="list-disc pl-6">
        ...
        <li><b>Third-Party Data:</b> Information obtained from integrations you authorize, including profile data, messages, files, and activity logs, as permitted by your settings with those services.</li>
    ...
    <section className="mb-6">
      ...
      <ul className="list-disc pl-6">
        <li>We do not use your private data to train public models.</li>
        <li>We do not sell, rent, or trade your personal data.</li>
        <li>We do not access third party accounts unless you explicitly connect them.</li>
      </ul>
    </section>
    <section className="mb-6">
    ...
    <section className="mb-6">
      <h2 className="text-xl font-semibold mb-2">AI and Tool Usage</h2>
      <p>
    ...
    <section className="mb-6">
      ...
      <ul className="list-disc pl-6">
        ...
        <li><b>Third-Party Integrations:</b> Data is shared with third party services only when you explicitly authorize such integrations. You control what is shared and can revoke access at any time.</li>
