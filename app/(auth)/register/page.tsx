          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative flex items-center">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-zinc-500 dark:text-zinc-400 focus:outline-none hover:text-zinc-700 dark:hover:text-zinc-300"
                tabIndex={0}
                disabled={state.status === "in_progress"}
              >
