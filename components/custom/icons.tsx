...
export const ThumbUpIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} width={size} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 10.5V17C2 17.5523 2.44772 18 3 18H7.5C7.77614 18 8 17.7761 8 17.5V10.5C8 10.2239 7.77614 10 7.5 10H3C2.44772 10 2 10.4477 2 11V10.5Z" fill="currentColor"/>
    <path d="M8 17.5V10.5C8 10.2239 8.22386 10 8.5 10H13.382C13.7647 10 14.1182 9.78929 14.2764 9.44721L16.2764 5.44721C16.6342 4.73478 16.1066 4 15.2764 4H12.5C12.2239 4 12 3.77614 12 3.5V2.5C12 2.22386 11.7761 2 11.5 2C11.2239 2 11 2.22386 11 2.5V3.5C11 4.32843 10.3284 5 9.5 5H8.5C8.22386 5 8 5.22386 8 5.5V17.5Z" fill="currentColor"/>
  </svg>
);

export const ThumbDownIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} width={size} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 9.5V3C2 2.44772 2.44772 2 3 2H7.5C7.77614 2 8 2.22386 8 2.5V9.5C8 9.77614 7.77614 10 7.5 10H3C2.44772 10 2 9.55228 2 9V9.5Z" fill="currentColor"/>
    <path d="M8 2.5V9.5C8 9.77614 8.22386 10 8.5 10H13.382C13.7647 10 14.1182 10.2107 14.2764 10.5528L16.2764 14.5528C16.6342 15.2652 16.1066 16 15.2764 16H12.5C12.2239 16 12 16.2239 12 16.5V17.5C12 17.7761 11.7761 18 11.5 18C11.2239 18 11 17.7761 11 17.5V16.5C11 15.6716 10.3284 15 9.5 15H8.5C8.22386 15 8 14.7761 8 14.5V2.5Z" fill="currentColor"/>
  </svg>
);
...
export const CopyIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} width={size} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="3" y="3" width="10" height="10" rx="2" fill="currentColor" fillOpacity="0.5"/>
  </svg>
);
...
export const MehIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} width={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M9 9H9.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M15 9H15.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
export const FrownIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} width={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M8 16C8 16 9 14 12 14C15 14 16 16 16 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M9 9H9.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M15 9H15.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
